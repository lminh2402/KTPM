...
// Chart colors
const COLORS = ['#f44336', '#4caf50', '#ff9800', '#f44336', '#9c27b0', '#00bcd4'];
                ...
                <Box sx={{ height: 350, pt: 2 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Legend />
                      <Bar dataKey="mandatory" name="Mandatory Fees" fill="#f44336" />
                      ...
                      <PieChart>
                        ...
                        >
                          {paymentsByFee.map((entry, index) => {
                            // Use red for mandatory fees, green for voluntary fees (consistent with bar chart)
                            const color = entry.type === 'MANDATORY' ? '#f44336' : '#4caf50';
