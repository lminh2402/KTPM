...
const TemporaryResidenceForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Dispatch custom event to notify person detail page to refresh
      window.dispatchEvent(new CustomEvent('temporaryResidenceUpdated', { 
        detail: { personId: formData.personId } 
      }));
